<script>
import $ from "jquery"; // Settle down... this is Bootstrap 4 we are talking about.
export default {
  name: "BsModal",
  data() {
    return {
...
<template>
  <div class="modal fade" tabindex="-1" role="dialog" :aria-labelledby="titleId" :aria-describedby="bodyId"
       aria-hidden="true">
